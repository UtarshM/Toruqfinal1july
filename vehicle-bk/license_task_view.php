...
<title>License Tasks - <?php echo $row_rto->rto_name." - ".$row_rto->rto_contact; ?>  - <?php echo $meta_title; ?></title>
   ...
   function deleterec(id,rto_id)
	{
		...
		{
			window.location="license_task_delete.php?rtsk_id="+id+"&rto_id="+rto_id;
		}
	} 
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-table"></i> License Tasks [<?php echo $row_rto->rto_name." - ".$row_rto->rto_contact; ?>] </h2>
      <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
        <ol class="breadcrumb">
          ...
          <li class="active">License Tasks [<?php echo $row_rto->rto_name." - ".$row_rto->rto_contact; ?>] </li>
        </ol>
      </div>
    </div>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          if ( isset( $_GET[ 'flag' ] ) ) {
            ?>
          <?php if($_GET['flag']==1) {?>
          <p class="mb20" style="color:green">License Tasks details added successfully.</p>
          <?php } else if($_GET['flag']==2) {?>
          <p class="mb20" style="color:green">License Tasks details updated successfully.</p>
          <?php } else if($_GET['flag']==3) {?>
          <p class="mb20" style="color:green">License Tasks details deleted successfully.</p>
          <?php } else if($_GET['flag']==4) {?>
          <p class="mb20" style="color:green">License Tasks details assign action applied successfully.</p>
