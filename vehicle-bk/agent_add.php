...
if ( isset( $_POST[ "submit" ] ) ) {
  ...
  $agt_added = date( 'Y-m-d H:i:s' );
  $agt_updated = date( 'Y-m-d H:i:s' );
  // Check  Duplicate Record
  $query_agt_dup = "SELECT * FROM agent_detail where agt_number='" . $agt_number . "'  and agt_status='1'";
  ...
  if ( $total_records_dup >= 1 ) {
    ...
    $sql_agt_ins = "INSERT INTO agent_detail (agt_number, added_by, updated_by, agt_status, agt_added , agt_updated) VALUES ('" . $agt_number . "', '" . $added_by . "','" . $updated_by . "','" . $agt_status . "','" . $agt_added . "','" . $agt_updated . "')";
    if ( $con->query( $sql_agt_ins ) === TRUE ) {
      header( 'Location: agent_view.php?flag=1' );
    } else {
...
<title>Agent -<?php echo " ".$project_title." "; ?></title>
...
<div class="pageheader">
  <h2><i class="fa fa-plus"></i> Agent  </h2>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="phone" pattern="\d*" minlength="10" maxlength="10" name="agt_number" value="<?php echo $agt_number; ?>" class="form-control" placeholder="ex: 9898569898" required />
              </div>
            </div>
