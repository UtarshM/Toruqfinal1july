...
$col_cdo = "SELECT * FROM fitper_detail cd where fp_code_no LIKE 'FP%' ORDER BY cd.fp_id DESC";
$result_col_cdo = $con->query( $col_cdo );
$total_records = $result_col_cdo->num_rows + 1;
$fp_code_no = "FP" . $total_records;
// echo $fp_code_no; exit;
if ( isset( $_POST[ "submit" ] ) ) {
  ...
  {	
    ...
    // echo " IN Valid File";
    header("Location: fitper_add.php?&msg=erimgext");  exit;
    }
      ///// FILE EXT 
   }
  ////// IMAGE UPLOAD
  ...
  // $query_fp_dup = "SELECT * FROM fitper_detail where fp_regno='".$fp_regno."' and fp_status!='3' ";
  // $result_fp_dup = $con->query( $query_fp_dup );
  // $total_records_fp_dup = $result_fp_dup->num_rows;
  // if ( $total_records_fp_dup >= 1 ) {
  //   $flag = 11;
  //   $fp_date = $fp_date;
   //   $fp_regno = $fp_regno;
  //   $fp_name = $fp_name;
  ...
  // } else {
   $sql_expe_ins = "INSERT INTO fitper_detail (branch_id, fp_code_no,  fp_date, fp_regno, fp_pdf, fp_name, added_by, updated_by, fp_status, added_date, updated_date) VALUES ('" . $branch_id . "','" . $fp_code_no . "','" . $fp_date . "','" . $fp_regno . "','" . $fp_pdf . "','" . $fp_name . "','" . $added_by . "','" . $updated_by . "','" . $fp_status . "','" . $added_date . "','" . $updated_date . "')";

    // echo $sql_expe_ins; exit;
    if ( $con->query( $sql_expe_ins ) === TRUE ) {
      header( 'Location: fitper_view.php?flag=1' );
    } else {
      header( 'Location: fitper_add.php' );
    }
  // } // Check  Duplicate Record
}
?>
...
<title>Add Fitness & Permit PDF  -<?php echo $meta_title; ?></title>
...
<div class="pageheader">
  <h2><i class="fa fa-plus"></i> Add Fitness & Permit PDF </h2>
  <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a style="color:#1C1B17;" href="rto_dashboard.php">Dashboard</a></li>
      <li class="active">Add Fitness & Permit PDF </li>
    </ol>
  </div>
</div>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
              ...
              <div class="col-sm-9">
                <input type="text" disabled class="form-control" value="<?php echo $fp_code_no; ?>"  />
              </div>
            </div>
            ...
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
              ...
              <div class="col-sm-9">
                <input type="date" name="fp_date" class="form-control" value="<?php if($fp_date!="") { $datend   = new DateTime($fp_date); echo $datend->format('Y-m-d'); } else { $datend   = new DateTime(); echo $datend->format('Y-m-d'); } ?>" required />
              </div>
            </div>
            ...
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
              ...
              <div class="col-sm-9">
                <input type="text" name="fp_regno" class="form-control" required value="<?php echo $fp_regno; ?>" placeholder="GJ01AJ5896" />
              </div>
            </div>
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
              <label class="col-sm-3 control-label">Fitness & Permit PDF PDF (Only PDF) <span class="asterisk">*</span> </label>
              <div class="col-sm-9">
              <input type="file" name="fp_pdf" id=""  class="form-control" required />
              </div>
            </div>
            ...
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
              ...
              <div class="col-sm-9">
                <input type="text" name="fp_name" class="form-control" required value="<?php echo $fp_name; ?>" placeholder="Jakirhusen Parasara" />
              </div>
            </div>
            ...
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
              ...
              <div class="col-sm-9">
                <select required class="form-control" name="fp_status">
                  <?php
