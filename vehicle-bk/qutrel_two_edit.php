...
if ( isset( $_POST[ "submit" ] ) ) {
  ...
  $query_qtr_dup = "SELECT * FROM qutrel_two_detail where qtr_id!='" . $qtr_id . "' and cmp_id='" . $cmp_id . "' and ctg_id='" . $ctg_id . "' and qtr_status='1'";
  ...
  if ( $total_records_dup >= 1 ) {
    ...
    $sql_quotation_relationship_updt = "UPDATE qutrel_two_detail SET cmp_id='" . $cmp_id . "', ctg_id='" . $ctg_id . "', qtr_percentage='" . $qtr_percentage . "', qtr_profit='" . $qtr_profit . "', qtr_remarks='" . $qtr_remarks . "', updated_by ='" . $updated_by . "', qtr_status='" . $qtr_status . "',  qtr_updated='" . $qtr_updated . "' WHERE qtr_id=" . $qtr_id;
    if ( $con->query( $sql_quotation_relationship_updt ) === TRUE ) {
      header( 'Location: qutrel_two_view.php?flag=2' );
    } else {
      header( 'Location: qutrel_two_edit.php?qtr_id=' . $qtr_id );
    }
  }
}
$query_state_detail = "SELECT * FROM qutrel_two_detail ld where ld.qtr_id=" . $qtr_id;
...
<title>Quotation Relationship - 2 Edit -<?php echo " ".$project_title." "; ?></title>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-pen"></i> Quotation Relationship - 2 Edit </h2>
      <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a style="color:#1C1B17;" href="#">Dashboard</a></li>
          <li class="active">Quotation Relationship - 2 Edit</li>
        </ol>
      </div>
    </div>
          ...
          <form method="post"  name="frmadmin_changepwd" enctype="multipart/form-data" id="" class="" action="" >
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Quotation Relationship - 2</h4>
                <?php if(isset($flag)==11){?>
                <p style="color:red;">This relationship is already exists</p>
                <?php } ?>
                <p>Please set Quotation Relationship - 2 details here</p>
              </div>
              ...
              <div class="panel-footer">
                <div class="row">
                  <div class="col-sm-9 col-sm-offset-3">
                    ...
                    <input type="reset" style="background:#FFFFFF" class="btn btn-default" value="Cancel" onClick="location.href='qutrel_two_view.php'">
                  </div>
                </div>
              </div>
            </div>
