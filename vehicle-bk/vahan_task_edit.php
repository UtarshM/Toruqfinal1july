...
if ( isset( $_POST[ "submit" ] ) ) {
  ...
  if ( $con->query( $sql_expe_updt ) === TRUE ) {
    header( 'Location: vahan_task_view.php?flag=2&rto_id='.$rto_id ); exit;
  } else {
    header( 'Location: vahan_task_edit.php?rtsk_id='.$rtsk_id.'&rto_id='.$rto_id.'' );  exit;
  }
}
...
<title>Vahan Task Edit - <?php echo $row_rto->rto_name." - ".$row_rto->rto_contact; ?>   -<?php echo $meta_title; ?></title>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-pen"></i> Vahan Task Edit [<?php echo $row_rto->rto_name." - ".$row_rto->rto_contact; ?> ] </h2>
      <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
        <ol class="breadcrumb">
          ...
          <li><a style="color:#1C1B17;" href="vahan_task_view.php?rto_id=<?php echo $rto_id; ?>">  Vahan Tasks  </a></li>
          <li class="active">Vahan Task Edit [<?php echo $row_rto->rto_name." - ".$row_rto->rto_contact; ?> ] </li>
        </ol>
      </div>
    </div>
          ...
          <form method="post" name="frmadmin_changepwd" enctype="multipart/form-data" id="" class="" action="">
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Vahan Task Details</h4>
              ...
              <div class="panel-footer">
                <div class="row">
                  <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12 ml_15">
                    ...
                    <input type="reset" style="background:#FFFFFF" class="btn btn-default" value="Cancel" onClick="location.href='vahan_task_view.php?rto_id=<?php echo $rto_id; ?>'">
                  </div>
                </div>
              </div>
            </div>
