<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		{	
			...
			// echo " IN Valid File";
			header("Location: vahan_documents.php?rto_id=".$_GET["rto_id"]."&msg=erimgext");  exit;
    ...
    ////// IMAGE UPLOAD
		...
		// 	}
 		// }
 		header('Location: vahan_documents.php?flag=1&rto_id='.$rto_id);
	}
    ...
    <div class="pageheader">
      ...
      <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
        <ol class="breadcrumb">
          ...
          <li><a href="vahan_view.php">Vahan Work List </a></li>
		  ...
		  ?>
              ...
              <div class="panel-footer">
                ...
                <div class="col-sm-2" style="border: 1px solid #ddd;">
                  ...
                  <a style="color:red" onClick="return confirm('Are you sure want to delete?')"  href="vahan_document_delete.php?document_id=<?php echo  $gallery->document_id; ?>&rto_id=<?php echo $rto_id; ?> " class="link" style="font-size:12px"><i class="fa fa-trash"></i></a> </div>
                <?php } else { ?>
                <div class="col-sm-2" style="border: 1px solid #ddd;"> <a href="img/document_files/<?php  echo $gallery->document_image; ?>"  data-rel="prettyPhoto"> <img style="margin-bottom: 5px;" src="img/document_files/<?php  echo $gallery->document_image; ?>" class="img-responsive"></a>
                  ...
                  <br>
                  <a style="color:red" onClick="return confirm('Are you sure want to delete?')"  href="vahan_document_delete.php?document_id=<?php echo  $gallery->document_id; ?>&rto_id=<?php echo $rto_id; ?> " class="link" style="font-size:12px"><i class="fa fa-trash"></i></a> <br>
                  <br>
                </div>
                <?php } ?>
                <?php
