...
if ( isset( $_POST[ "submit" ] ) ) {
  ...
  $query_qtr_dup = "SELECT * FROM qutrel_two_detail where cmp_id='" . $cmp_id . "'  and ctg_id='" . $ctg_id . "'  and qtr_status='1'";
  ...
  if ( $total_records_dup >= 1 ) {
    ...
    $sql_qtr_ins = "INSERT INTO qutrel_two_detail (cmp_id, ctg_id, qtr_percentage, qtr_profit, qtr_remarks, added_by, updated_by, qtr_status, qtr_added , qtr_updated) VALUES ('" . $cmp_id . "','" . $ctg_id . "','" . $qtr_percentage . "','" . $qtr_profit . "','" . $qtr_remarks . "', '" . $added_by . "','" . $updated_by . "','" . $qtr_status . "','" . $qtr_added . "','" . $qtr_updated . "')";
    if ( $con->query( $sql_qtr_ins ) === TRUE ) {
      header( 'Location: qutrel_two_view.php?flag=1' );
    } else {
      header( 'Location: qutrel_two_add.php' );
    }
  }
  // Check  Duplicate Record
}
...
<title>Quotation Relationship - 2 -<?php echo " ".$project_title." "; ?></title>
...
<div class="pageheader">
  <h2><i class="fa fa-plus"></i> Quotation Relationship - 2  </h2>
  <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a style="color:#1C1B17;" href="#">Dashboard</a></li>
      <li class="active">Quotation Relationship - 2</li>
    </ol>
  </div>
</div>
