...
if ( isset( $_POST[ "submit" ] ) ) {
  ...
  $query_qtr_dup = "SELECT * FROM qutrel_three_detail where cmp_id='" . $cmp_id . "'  and ctg_id='" . $ctg_id . "'  and qtr_status='1'";
  ...
  if ( $total_records_dup >= 1 ) {
    ...
    $sql_qtr_ins = "INSERT INTO qutrel_three_detail (cmp_id, ctg_id, qtr_percentage, qtr_profit, qtr_remarks, added_by, updated_by, qtr_status, qtr_added , qtr_updated) VALUES ('" . $cmp_id . "','" . $ctg_id . "','" . $qtr_percentage . "','" . $qtr_profit . "','" . $qtr_remarks . "', '" . $added_by . "','" . $updated_by . "','" . $qtr_status . "','" . $qtr_added . "','" . $qtr_updated . "')";
    if ( $con->query( $sql_qtr_ins ) === TRUE ) {
      header( 'Location: qutrel_three_view.php?flag=1' );
    } else {
      header( 'Location: qutrel_three_add.php' );
    }
  }
  // Check  Duplicate Record
}
...
<title>Quotation Relationship - 3 -<?php echo " ".$project_title." "; ?></title>
...
<div class="pageheader">
  <h2><i class="fa fa-plus"></i> Quotation Relationship - 3  </h2>
  <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a style="color:#1C1B17;" href="#">Dashboard</a></li>
      <li class="active">Quotation Relationship - 3</li>
    </ol>
  </div>
</div>
        ...
        <div class="panel panel-default">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="qtr_remarks" value="<?php echo $qtr_remarks; ?>" class="form-control" placeholder="ex: This vehicle not accepatable" />
              </div>
            </div>
