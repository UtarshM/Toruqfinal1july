...
// Check Module Rights
$col_cdo="SELECT * FROM rto_detail cd where rto_code_no LIKE 'VHN%' ORDER BY cd.rto_id DESC";
$result_col_cdo=$con->query( $col_cdo );
$max_rto_id=$result_col_cdo->num_rows + 1;
$rto_code_no="VHN" . $max_rto_id;
...
if ( isset( $_POST[ "submit" ] ) ) {
  ...
  $sql_expe_ins = "INSERT INTO rto_detail (branch_id, rto_code_no,  rto_adm_id, service_id, service_multiple, rto_date, rto_duedate, rto_regno, rto_name, rto_contact, rto_amount, rto_credit, rto_debit, rto_description, added_by, updated_by, rto_status, rto_action, pen_res_id, rto_stage_no, rto_stage_name, added_date, updated_date) VALUES ('" . $branch_id . "','" . $rto_code_no . "','" . $rto_adm_id . "','" . $service_id . "','" .$service_multiple."','" . $rto_date . "','" . $rto_duedate . "','" . $rto_regno . "','" . $rto_name . "','" . $rto_contact . "','" . $rto_amount . "','" . $rto_credit . "','" . $rto_debit . "','" . $rto_description . "','" . $added_by . "','" . $updated_by . "','" . $rto_status . "','" . $rto_action . "','" . $pen_res_id . "', '" . $rto_stage_no . "', '" . $rto_stage_name . "','" . $added_date . "','" . $updated_date . "')";
  // echo $sql_expe_ins; exit;
  if ( $con->query( $sql_expe_ins ) === TRUE ) {
    header( 'Location: vahan_view.php?flag=1' );
  } else {
    header( 'Location: vahan_add.php' );
  }
}
?>
<!DOCTYPE html>
...
<title>Add Vahan Work  -<?php echo $meta_title; ?></title>
...
<div class="pageheader">
  <h2><i class="fa fa-plus"></i> Add Vahan Work </h2>
  <div class="breadcrumb-wrapper"> <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a style="color:#1C1B17;" href="rto_dashboard.php">Dashboard</a></li>
      <li class="active">Add Vahan Work </li>
    </ol>
  </div>
</div>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
              ...
              <div class="col-sm-9">
                <input type="text" name="rto_regno" class="form-control" required value="<?php echo $rto_regno; ?>" placeholder="GJ01CV0267"  />
              </div>
            </div>
            <div class="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <?php
                 $query_service = "SELECT * FROM service_detail where service_status='1' and service_type=2 ORDER BY service_id";
